...
alias speed_of_light:Scalar[f64] = 299792458.0  # speed of light in vacuum [m s^-1]

# Magnetic and electric constants
alias mu_0:Scalar[f64] = 1.25663706127e-06  # vacuum magnetic permeability [N A^-2]
alias epsilon_0:Scalar[f64] = 8.8541878188e-12  # vacuum electric permittivity [F m^-1]

# Planck constants
alias h:Scalar[f64] = 6.62607015e-34  # Planck constant [J Hz^-1]
alias Planck:Scalar[f64] = 6.62607015e-34  # Planck constant [J Hz^-1]
alias hbar:Scalar[f64] = 1.0545718176461565e-34  # reduced Planck constant [J s]

# Gravitational constants
alias G:Scalar[f64] = 6.6743e-11  # Newtonian constant of gravitation [m^3 kg^-1 s^-2]
alias gravitational_constant:Scalar[f64] = 6.6743e-11  # Newtonian constant of gravitation [m^3 kg^-1 s^-2]
...
alias gas_constant:Scalar[f64] = 8.31446261815324  # molar gas constant [J mol^-1 K^-1]

# Fine structure constant
alias alpha:Scalar[f64] = 0.0072973525643  # fine-structure constant [dimensionless]
alias fine_structure:Scalar[f64] = 0.0072973525643  # fine-structure constant [dimensionless]
...
alias sigma:Scalar[f64] = 5.6703744191844314e-08  # Stefan-Boltzmann constant [W m^-2 K^-4]
alias Stefan_Boltzmann:Scalar[f64] = 5.6703744191844314e-08  # Stefan-Boltzmann constant [W m^-2 K^-4]

# Wien displacement law constant
alias Wien:Scalar[f64] = 0.0028977719551851727  # Wien wavelength displacement law constant [m K]
...
alias long_ton:Scalar[f64] = 1016.0469088  # long ton [kg]:Scalar[f64] = 2240*pound
alias short_ton:Scalar[f64] = 907.18474  # short ton [kg]:Scalar[f64] = 2000*pound

# Specialized mass units
alias troy_ounce:Scalar[f64] = 0.0311034768  # troy ounce [kg]:Scalar[f64] = 480*grain
alias troy_pound:Scalar[f64] = 0.3732417216  # troy pound [kg]:Scalar[f64] = 12*troy_ounce
alias carat:Scalar[f64] = 0.0002  # carat [kg]:Scalar[f64] = 200e-6
alias blob:Scalar[f64] = 175.126835246  # blob [kg]:Scalar[f64] = pound*g/0.0254
alias slinch:Scalar[f64] = 175.126835246  # slinch [kg]:Scalar[f64] = pound*g/0.0254
...
alias degree:Scalar[f64] = 0.017453292519943295  # degree [rad]:Scalar[f64] = pi/180
alias arcmin:Scalar[f64] = 0.00029088820866572158  # arcminute [rad]:Scalar[f64] = degree/60
alias arcminute:Scalar[f64] = 0.00029088820866572158  # arcminute [rad]:Scalar[f64] = degree/60
alias arcsec:Scalar[f64] = 4.8481368110953599e-06  # arcsecond [rad]:Scalar[f64] = arcmin/60
alias arcsecond:Scalar[f64] = 4.8481368110953599e-06  # arcsecond [rad]:Scalar[f64] = arcmin/60
...
alias Julian_year:Scalar[f64] = 31557600.0  # Julian year [s]:Scalar[f64] = 365.25*day
...
alias pt:Scalar[f64] = 0.00035277777777777776  # point [m]:Scalar[f64] = inch/72
alias point:Scalar[f64] = 0.00035277777777777776  # point [m]:Scalar[f64] = inch/72

# Survey units
alias survey_foot:Scalar[f64] = 0.30480060960121924  # survey foot [m]:Scalar[f64] = 1200.0/3937
alias survey_mile:Scalar[f64] = 1609.3472186944375  # survey mile [m]:Scalar[f64] = 5280*survey_foot
...
alias light_year:Scalar[f64] = 9460730472580800.0  # light year [m]:Scalar[f64] = Julian_year*c
alias parsec:Scalar[f64] = 3.0856775814913673e16  # parsec [m]:Scalar[f64] = au/arcsec
...
alias psi:Scalar[f64] = 6894.757293168361  # psi [Pa]:Scalar[f64] = pound*g/(inch*inch)
...
# US volume
alias gallon:Scalar[f64] = 0.003785411784  # gallon (US) [m^3]:Scalar[f64] = 231*inch^3
alias gallon_US:Scalar[f64] = 0.003785411784  # gallon (US) [m^3]:Scalar[f64] = 231*inch^3
alias fluid_ounce:Scalar[f64] = 2.95735295625e-05  # fluid ounce (US) [m^3]:Scalar[f64] = gallon_US/128
alias fluid_ounce_US:Scalar[f64] = 2.95735295625e-05  # fluid ounce (US) [m^3]:Scalar[f64] = gallon_US/128
alias bbl:Scalar[f64] = 0.158987294928  # barrel [m^3]:Scalar[f64] = 42*gallon_US
alias barrel:Scalar[f64] = 0.158987294928  # barrel [m^3]:Scalar[f64] = 42*gallon_US

# UK volume
alias gallon_imp:Scalar[f64] = 0.00454609  # gallon (UK) [m^3]:Scalar[f64] = 4.54609e-3
alias fluid_ounce_imp:Scalar[f64] = 2.8413062499999997e-05  # fluid ounce (UK) [m^3]:Scalar[f64] = gallon_imp/160

# =======================
# SPEED IN METERS PER SECOND
# =======================

alias kmh:Scalar[f64] = 0.2777777777777778  # km/h [m s^-1]:Scalar[f64] = 1e3/hour
alias mph:Scalar[f64] = 0.44704  # mph [m s^-1]:Scalar[f64] = mile/hour
alias mach:Scalar[f64] = 340.5  # Mach [m s^-1] (approx at 15°C, 1 atm)
alias speed_of_sound:Scalar[f64] = 340.5  # speed of sound [m s^-1] (approx at 15°C, 1 atm)
alias knot:Scalar[f64] = 0.5144444444444445  # knot [m s^-1]:Scalar[f64] = nautical_mile/hour
...
alias degree_Fahrenheit:Scalar[f64] = 0.5555555555555556  # degree Fahrenheit [K] (for differences only):Scalar[f64] = 1/1.8
...
# Basic energy units
alias eV:Scalar[f64] = 1.602176634e-19  # electron volt [J]:Scalar[f64] = elementary_charge
alias electron_volt:Scalar[f64] = 1.602176634e-19  # electron volt [J]:Scalar[f64] = elementary_charge
...
alias calorie_IT:Scalar[f64] = 4.1868  # calorie (International Steam Table) [J]
alias erg:Scalar[f64] = 1e-07  # erg [J]:Scalar[f64] = 1e-7

# British thermal units
alias Btu_th:Scalar[f64] = 1054.3502644888888  # BTU (thermochemical) [J]:Scalar[f64] = pound*degree_Fahrenheit*calorie_th/gram
alias Btu:Scalar[f64] = 1055.05585262  # BTU (International Steam Table) [J]:Scalar[f64] = pound*degree_Fahrenheit*calorie_IT/gram
alias Btu_IT:Scalar[f64] = 1055.05585262  # BTU (International Steam Table) [J]

# Explosive energy
alias ton_TNT:Scalar[f64] = 4184000000.0  # ton of TNT [J]:Scalar[f64] = 1e9*calorie_th

# =======================
# POWER IN WATTS
# =======================

alias hp:Scalar[f64] = 745.6998715822702  # horsepower [W]:Scalar[f64] = 550*foot*pound*g
alias horsepower:Scalar[f64] = 745.6998715822702  # horsepower [W]:Scalar[f64] = 550*foot*pound*g
...
alias lbf:Scalar[f64] = 4.4482216152605  # pound force [N]:Scalar[f64] = pound*g
alias pound_force:Scalar[f64] = 4.4482216152605  # pound force [N]:Scalar[f64] = pound*g
alias kgf:Scalar[f64] = 9.80665  # kilogram force [N]:Scalar[f64] = g
alias kilogram_force:Scalar[f64] = 9.80665  # kilogram force [N]:Scalar[f64] = g
